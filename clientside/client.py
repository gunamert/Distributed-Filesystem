...
class RPYCFuse(Operations):
	...
	def __init__(self):
		try:
			self.server1 = rpyc.connect("10.0.2.15", 11025)
			self.server1_status = True
		except Exception as e:
			print("Server1 not available!")
		try:
			self.server2 = rpyc.connect("10.0.2.7", 11025)
			self.server2_status = True
		except Exception as e:
			print("Server2 not available!")
		try:
			self.server3 = rpyc.connect("10.0.2.8", 11025)
...
if __name__ == "__main__":
	mntpoint = '/home/slave/Desktop/fs_virt'
