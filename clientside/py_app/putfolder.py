...
server1_getsize_address = ('10.0.2.15', 3006)
server2_getsize_address = ('10.0.2.7', 3006)
server3_getsize_address = ('10.0.2.8', 3006)

server1_exists_address = ('10.0.2.15', 3007)
server2_exists_address = ('10.0.2.7', 3007)
server3_exists_address = ('10.0.2.8', 3007)

server1_address = ('10.0.2.15', 3005)
server2_address = ('10.0.2.7', 3005)
server3_address = ('10.0.2.8', 3005)
