...
@atexit.register
def goodbye():
	server1_address = ('10.0.2.15', 3006)
	server2_address = ('10.0.2.7', 3006)
	server1_mkdir = ('10.0.2.15', 3005)
	server2_mkdir = ('10.0.2.7', 3005)
	server1_putf = ('10.0.2.15', 3009)
	server2_putf = ('10.0.2.7', 3009)
	empty_message = 'a'
	server1_size = 0
	server2_size = 0
	server1_status = False
	...
	if nop is False:
		...
		for root, directories, filenames in os.walk('/home/slave/Desktop/fs_real'):
		...
		metadatafile.close()
		for root, directories, filenames in os.walk('/home/slave/Desktop/fs_real', topdown=False):
			for directory in directories:
...
class RPYCFuseService(rpyc.Service):
	...
	# | Variables
 	# +========================
	root = '/home/slave/Desktop/fs_real'
	# +========================
	# | Helpers
 	# +========================
	...
	def getpath(self, path):
		try:
			return '/home/slave/Desktop/fs_real' + path
		except Exception as e:
			print("Error: GETPATH")
			print(str(e))
...
if __name__ == "__main__":
	...
	nop = False
	path = '/home/slave/Desktop/fs_real/'
	server1_getfile = ('10.0.2.15', 3002)
	server2_getfile = ('10.0.2.7', 3002)
	server1_rmall = ('10.0.2.15', 3010)
	server2_rmall = ('10.0.2.7', 3010)
	server1_getlist = ('10.0.2.15', 3011)
	server2_getlist = ('10.0.2.7', 3011)
	active_server = ""
